...
export type CountryQuery = { __typename?: 'Query', country: { __typename?: 'Country', id: number, name: string, emoji: string, code: string, continent?: { __typename?: 'Continent', id: number, name: string } | null } };
